...
<body>
        ...
        <section class="section">
          ...
          {if substr($user->unusedTraffic(),0,-2) <= 0 and $user->class != 0}
            ...
            {if substr($user->unusedTraffic(),0,-2) <= 5 && substr($user->unusedTraffic(),0,-2) > 0 && {substr($user->unusedTraffic(),-2)} == 'GB'}
              ...
              <div class="alert alert-primary">
                <a href="https://www.97xh.cn/collection/tz" class="alert-link" style="font-weight:400">{$i18n->get('new-user-guide-alert')}</a>
              </div>
              {/if}
              <div class="row">
        ...
        <section class="section">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h3 class="animated tada mt-5 text-center" style="color:#191d21">👋 小可爱, {$user->user_name}</h3>
                  <h5 class="mb-5 mt-2 text-center" style="color:#191d21d5">{$i18n->get('new-user-guide-lead')}</h5>
                  <h6 class="mb-5 mt-2 text-center" style="color:#191d21d5"> &#x5DE6;&#x4FA7;&#x6709;&#x4E0B;&#x8F7D;&#x4E0E;&#x4F7F;&#x7528;&#x6559;&#x7A0B;！！！</h6>
                  <div class="row mt-4">
                    <div class="col-12 col-lg-8 offset-lg-2">
                      <div class="wizard-steps">
                        ...
                        <div class="wizard-step wizard-step-active" onclick="location='https://www.97xh.cn/collection/tz'">
                          <div class="wizard-step-icon">
                        ...
                        <div class="wizard-step wizard-step-active" onclick="location='https://YouTube.com'">
                          <div class="wizard-step-icon">
  ...
  <script src="https://www.97xh.cn/wp-content/uploads/2020/malio-js/jquery.counterup.min.js"></script>
