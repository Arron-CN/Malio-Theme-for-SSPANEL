          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                ...
                <div class="hero text-white hero-bg-image hero-bg-parallax mb-4" data-background="https://www.97xh.cn/wp-content/uploads/2020/malio-tupian/yaoqing.jpg" style="background-image: url(&quot;/theme/malio/img/soroush-karimi-crjPrExvShc-unsplash.jpg&quot;);">
